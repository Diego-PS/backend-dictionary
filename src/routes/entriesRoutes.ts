...
import { AddWordToFavorites, GetEntries, removeWordFromFavorites, ViewEntry } from 'use-cases'
...
const addWordToFavoritesUseCase = new AddWordToFavorites(userRepository, wordRepository)
const removeWordFromFavoritesUseCase = new removeWordFromFavorites(userRepository, wordRepository)
...
entriesRoutes.post('/en/:word/favorite', authenticate, asyncHandler(entriesController.addWordToFavorites))
entriesRoutes.delete('/en/:word/unfavorite', authenticate, asyncHandler(entriesController.removeWordFromFavorites))

...
export interface UserRepositoryInterface {
  ...
  getHistory(id: string, pagination: PaginationQuery): Promise<{ words: Word[], totalWords: number }>
  getFavorites(is: string, pagination: PaginationQuery): Promise<{ words: Word[], totalWords: number }>
